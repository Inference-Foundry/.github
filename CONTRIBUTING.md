...
1. Read this organization’s **[Code of Conduct](CODE_OF_CONDUCT.md)**.
...
|------------|-------------------|
| **super-ollama** | [super-ollama/CONTRIBUTING.md](https://github.com/Inference-Foundry/super-ollama/blob/main/CONTRIBUTING.md) (CGo, `ggml`, profiling requirements) |
...
To propose changes to the **org profile**, **team roster**, **project index**, or shared policies in [Inference-Foundry/.github](https://github.com/Inference-Foundry/.github), open a pull request here or open an issue using the **Org meta** template ([`ISSUE_TEMPLATE/org_meta.yml`](ISSUE_TEMPLATE/org_meta.yml)).
