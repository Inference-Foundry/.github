# Inference-Foundry `.github`

This repository is GitHub’s **[special `.github` organization repository](https://docs.github.com/en/organizations/collaborating-with-groups-in-your-organization/customizing-your-organizations-profile)** for **Inference Foundry**. It holds the org profile, shared community defaults, and lightweight docs that apply across projects—not product source code.

**Organization site:** [inference-foundry.github.io](https://inference-foundry.github.io/)
...
- **Changes to this repo** (profile copy, `docs/`, templates, policies): open a PR here. See [CONTRIBUTING.md](CONTRIBUTING.md).
- **Code or deep docs for a product** (e.g. super-ollama): use that repository instead.

## Relationship to `profile/README.md`

- **`profile/README.md`** — what visitors see on the **org** GitHub page.
- **`README.md` (this file)** — what visitors see when they open **this repository** in the browser.
